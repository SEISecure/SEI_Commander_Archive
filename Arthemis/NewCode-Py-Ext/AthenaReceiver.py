...
class AthenaReceiver(object):
    ...
    def set_up_connections(self):
        try:
            ...
            print("receivng from ",self.athena_ip, self.athena_port)
...
def build_message():
    ...
    current_general_order.weapon_control_order = 1
    current_general_order.behavior = 1
